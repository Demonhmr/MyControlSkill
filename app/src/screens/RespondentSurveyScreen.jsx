  ...
  return (
    <>
      ...
      <Banner tone="ok" title="Ответы анонимны">
        Руководитель увидит усреднённые оценки, а не ваши. Расчёт вообще не начнётся, пока анкеты не
        заполнят как минимум три человека. Если какой-то пункт вы не наблюдали — выбирайте «не могу
        оценить», это честнее средней оценки наугад.
      </Banner>
